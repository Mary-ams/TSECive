...
const Property1Default24 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[11.34%] w-[79.11%] top-[68.96%] left-[10.26%] leading-[119.5%] capitalize font-medium inline-block" style={{ color: isHovered ? "#f6f6f6" : "black" }}>{`Information Technology`}</div>
      <img
        className="absolute h-[22.99%] w-[24.16%] top-[28.66%] right-[38.1%] bottom-[48.36%] left-[37.73%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src={informatics}
      />
    </div>
...
export default Property1Default24;