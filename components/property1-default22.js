...
const Property1Default22 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[11.34%] w-[79.11%] top-[68.96%] left-[10.26%] leading-[119.5%] capitalize font-medium inline-block" style={{ color: isHovered ? "#f6f6f6" : "black" }}>{`Chemical Engineering`}</div>
      <img
        className="absolute h-[20.3%] w-[23.5%] top-[32.24%] right-[38.43%] bottom-[47.46%] left-[38.07%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src={labItems}
      />
    </div>
...
export default Property1Default22;
