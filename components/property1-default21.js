...
const Property1Default21 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[11.34%] w-[79.11%] top-[68.96%] left-[10.26%] leading-[119.5%] capitalize font-medium inline-block" style={{ color: isHovered ? "#f6f6f6" : "black" }}>{`EXTC`}</div>
      <img
        className="absolute h-[18.51%] w-[20.85%] top-[30.75%] right-[39.76%] bottom-[50.75%] left-[39.39%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src={electronics}
      />
    </div>
...
export default Property1Default21;
