...
const Property1Default5 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[11.34%] w-[79.11%] top-[68.96%] left-[10.26%] leading-[119.5%] capitalize font-medium inline-block" style={{ color: isHovered ? "#f6f6f6" : "black" }}>YouTube Links</div>
      <img
        className="absolute h-1/5 w-[22.18%] top-[29.85%] right-[39.09%] bottom-[50.15%] left-[38.73%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src={youTube}
      />
    </div>
