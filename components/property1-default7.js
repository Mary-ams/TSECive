...
const Property1Default7 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[11.34%] w-[79.11%] top-[68.96%] left-[10.26%] leading-[119.5%] capitalize font-medium inline-block" style={{ color: isHovered ? "#f6f6f6" : "black" }}>PDFs</div>
      <img
        className="absolute h-1/5 w-[22.18%] top-[30.15%] right-[39.09%] bottom-[49.85%] left-[38.73%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src={documentsFolder}
      />
    </div>
