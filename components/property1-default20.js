...
const Property1Default20 = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[36.11%] w-[32.73%] top-[39.81%] left-[35.35%] leading-[119.5%] capitalize font-medium inline-block">
        Semester 1
      </div>
      <StackframeFill
...
export default Property1Default20;