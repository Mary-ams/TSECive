...
const Property1Default12 = ({
  ...
  return (
    <div
      className="w-[495px] h-[139px] text-center text-5xl font-poppins rounded-xl transition duration-300"
      style={property1Default8Style}
    ...
    >
      ...
      <div className="absolute h-[28.06%] w-[32.73%] top-[41.73%] left-[35.35%] leading-[119.5%] capitalize font-medium inline-block transition duration-300" style={{ color: isHovered ? "#f6f6f6" : "black" }}>
        Subject 1
      </div>
      <StackframeFill
        stackframeFillStackframeF="/stackframe-fill.svg"
        stackframeFillIconWidth="19.39%"
        stackframeFillIconHeight="58.27%"
        stackframeFillIconPosition="absolute"
        stackframeFillIconTop="20.86%"
        stackframeFillIconRight="76.57%"
        stackframeFillIconBottom="20.86%"
